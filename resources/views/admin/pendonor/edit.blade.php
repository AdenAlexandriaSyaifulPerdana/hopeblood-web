...
<div class="max-w-xl mx-auto bg-white shadow-md rounded-3xl p-6 md:p-8">
    <h2 class="text-2xl font-bold text-slate-900 mb-2">Edit Pendonor</h2>
    <p class="text-sm text-slate-500 mb-6">
        Perbarui informasi akun pendonor berikut.
    </p>

    <form action="{{ route('admin.pendonor.update', $pendonor->id) }}" method="POST" class="space-y-5">
        @csrf
        @method('PUT')
